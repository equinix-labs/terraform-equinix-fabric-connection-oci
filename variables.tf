...
variable "oci_drg_name" {
  type        = string
  description = <<EOF
  The name for the Dynamic Routing Gateway. If unspecified and 'oci_create_drg' is true, it will be
  auto-generated. Required one of 'oci_drg_name' or 'oci_drg_id' if 'oci_create_drg' is set to
  'false'.
  EOF
  default     = ""
}
...
variable "oci_drg_id" {
  type        = string
  description = <<EOF
  The OCID of an existing Dynamic Routing Gateway. Required one of 'oci_drg_id' or 'oci_drg_name'
  if 'oci_create_drg' is set to 'false'.
  EOF
  default     = ""
}
...
variable "oci_drg_vcn_attachments" {
  ...
  ['vcn_route_type'](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/core_drg_attachment#vcn_route_type)
  (Optional. One of 'SUBNET_CIDRS', 'VCN_CIDRS'),
  ['vcn_transit_routing_rt_id'](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/core_drg_attachment#route_table_id)
  (VCN Route table - Use this advanced feature only if you're setting up transit routing),
  ['drg_route_table_id'](https://registry.terraform.io/providers/oracle/oci/latest/docs/resources/core_drg_attachment#drg_route_table_id)
  (DRG route table - If not specified, it will use the autogenerated DRG Route Table for VCN attachemts).
